...
const RegisterPage = () => {
  ...
  return (
    <div className="max-h-screen w-full">
      <section className="border-red-500 bg-gray-200 min-h-screen w-full flex items-center justify-center">
          ...
          <div className="sm:w-1/2 px-10 sm:px-3 sm:py-3 md:py-5">
            <div className=" text-center mb-8 sm:mb-4 px-8">
              ...
              <p className="text-xs text-[#959595] font-roboto">
                Register to create your first account and unlock a world of
                event possibilities!
              </p>
            </div>
                  ...
                  <input
                    ...
                    {...register("lastName", {
                      minLength: {
                        value: 1,
                        message:
                          "Last Name length must be at least 1 character",
                      },
                      required: {
                        value: true,
